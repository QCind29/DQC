...
package com.food.lite.nckh.detection.tracking;
...
import com.food.lite.nckh.detection.env.BorderedText;
import com.food.lite.nckh.detection.env.ImageUtils;
import com.food.lite.nckh.detection.env.Logger;
import com.food.lite.nckh.detection.tflite.Classifier.Recognition;
...
//                      : String.format("%.2f", (100 * recognition.detectionConfidence));
              !TextUtils.isEmpty(recognition.title) // SRA added
                      ? String.format("%s", recognition.title) // SRA added
                      : String.format("%s", "detection");
