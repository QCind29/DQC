...
import com.food.lite.nckh.detection.MainActivity;
...
//            return recognitions;
//        } catch (Exception e) {
//            // Handle the exception (e.g., log it or take appropriate actions)
//            e.printStackTrace();
//            return new ArrayList<Recognition>(); // Return an empty list as a fallback
//        }
//    }
